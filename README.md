...
- 📋 [PROJECT SPECIFICATION (요구사항 정의 및 기능 명세서)](documents/info/Project_Specification.md) (정화 버전)
- 📋 [ADMIN FLOW SPECIFICATION (관리자 기능 설계서)](documents/info/카페%20키오스크_관리자%20기능%20관리%20명세서.md) (정화 버전)
- 🚨 [TROUBLESHOOTING (DB 예약어 충돌, 주문 오류 등 장애 색인)](documents/TROUBLESHOOTING.md)
- 🗓️ [PROJECT LOGS (날짜별 세부 개발 기록/수정 로그)](documents/project-log/)
...
- 🛠️ [CheckData.java (데이터 검증 및 테스트 유틸)](src/CheckData.java)
